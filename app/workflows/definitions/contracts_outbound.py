...
@register_workflow
class ContractsOutboundWorkflow(BaseWorkflow):
    name = "contracts_outbound"

    def get_extract_step(self) -> OracleExtractStep:
        connector = create_connector("oracle", settings.oracle_dsn)
        return OracleExtractStep(connector, CONTRACTS_QUERY, settings.batch_size)
    ...
    def get_load_step(self) -> SqlServerLoadStep:
        ...
        return SqlServerLoadStep(connector, "dbo.contracts_outbound")
